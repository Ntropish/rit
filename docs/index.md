...
Rit is a versioned key-value store in a single file. It combines Redis-like data operations with Git-like version control, built on content-addressed prolly trees.
